...
namespace Rca.Physical.Helpers
{
	...
	public abstract partial class SpecificVolume
	{
		...
		public static PhysicalValue FromCubicMetrePerKilograms(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.CubicMetrePerKilogram, scaling);
