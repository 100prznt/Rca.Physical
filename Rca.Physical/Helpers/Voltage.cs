...
namespace Rca.Physical.Helpers
{
	...
	public abstract partial class Voltage
	{
		...
		public static PhysicalValue FromVolts(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Volt, scaling);
		...
		public static PhysicalValue FromMillivolts(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Millivolt, scaling);
		...
		public static PhysicalValue FromKilovolts(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Kilovolt, scaling);
