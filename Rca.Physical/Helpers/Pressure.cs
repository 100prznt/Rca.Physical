...
namespace Rca.Physical.Helpers
{
	...
	public abstract partial class Pressure
	{
		...
		public static PhysicalValue FromBars(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Bar, scaling);
		...
		public static PhysicalValue FromMillibars(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Millibar, scaling);
		...
		public static PhysicalValue FromPascals(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Pascal, scaling);
		...
		public static PhysicalValue FromKilopascals(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Kilopascal, scaling);
		...
		public static PhysicalValue FromMegapascals(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Megapascal, scaling);
		...
		public static PhysicalValue FromPsis(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Psi, scaling);
		...
		public static PhysicalValue FromMetresOfWaterGauges(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.MetresOfWaterGauge, scaling);
		...
		public static PhysicalValue FromStandardAtmospheres(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.StandardAtmosphere, scaling);
