...
namespace Rca.Physical.Helpers
{
	...
	public abstract partial class Volume
	{
		...
		public static PhysicalValue FromCubicMetres(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.CubicMetre, scaling);
		...
		public static PhysicalValue FromCubicCentimetres(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.CubicCentimetre, scaling);
		...
		public static PhysicalValue FromLitres(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Litre, scaling);
		...
		public static PhysicalValue FromMillilitres(double value, ScaleOfMeasurements scaling = ScaleOfMeasurements.NotDefined) => new(value, PhysicalUnits.Millilitre, scaling);
